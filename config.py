...
# ────────────────────────────────────────────────────────────────────────────────
# ארנקים פעילים — POLLING שוטף בכל סיבוב (20 ארנקים)
# קריטריון כניסה: פעיל ב-30 יום אחרונים + רווח מוכח ביצועים
# ────────────────────────────────────────────────────────────────────────────────
ACTIVE_WALLETS = {
    # ─ לווייתן פעיל ────────────────────────────────────────────────────────────────────────────
    "HorizonSplendidView": "0x02227b8f5a9636e895607edd3185ed6ee5598ff7",  # ספורט אירופאי | +$4.0M | פעיל 2026
    # ─ מומחים פעילים ───────────────────────────────────────────────────────────────────────────
    "kch123":               "0x6a72f61820b26b1fe4d956e17b6dc2a1ea3033ee",  # פעיל מאוד | רב-תחומי
    "DrPufferfish":         "0xdb27bf2ac5d428a9c63dbc914611036855a6c56e",  # פעיל מאוד | ספורט
    "RN1":                  "0x2005d16a84ceefa912d4e380cd32e7ff827875ea",  # פעיל מאוד | ספורט
    "GCottrell93":          "0x94a428cfa4f84b264e01f70d93d02bc96cb36356",  # פעיל מאוד | ספורט
    "swisstony":            "0x204f72f35326db932158cba6adff0b9a1da95e14",  # פעיל מאוד | רב-תחומי
    "GamblingIsAllYouNeed": "0x507e52ef684ca2dd91f90a9d26d149dd3288beae",  # פעיל מאוד | ספורט
    "beachboy4":            "0xc2e7800b5af46e6093872b177b7a5e7f0563be51",  # פעיל מאוד | ספורט
    "anoin123":             "0x96489abcb9f583d6835c8ef95ffc923d05a86825",  # פעיל מאוד | רב-תחומי
    "weflyhigh":            "0x03e8a544e97eeff5753bc1e90d46e5ef22af1697",  # פעיל מאוד | ספורט
    "YatSen":               "0x5bffcf561bcae83af680ad600cb99f1184d6ffbe",  # פעיל מאוד | רב-תחומי
    "SwissMiss":            "0xdbade4c82fb72780a0db9a38f821d8671aba9c95",  # פעיל מאוד | ספורט
    "KeyTransporter":       "0x94f199fb7789f1aef7fff6b758d6b375100f4c7a",  # פעיל | רב-תחומי
    "gmanas":               "0xe90bec87d9ef430f27f9dcfe72c34b76967d5da2",  # פעיל | ספורט
    "blackwall":            "0xac44cb78be973ec7d91b69678c4bdfa7009afbd7",  # פעיל | ספורט אירופאי
    "gmpm":                 "0x14964aefa2cd7caff7878b3820a690a03c5aa429",  # פעיל | רב-תחומי
    "majorexploiter":       "0x019782cab5d844f02bafb71f512758be78579f3c",  # פעיל | ספורט אירופאי | +$2.42M
    "0x8dxd":              "0x63ce342161250d705dc0b16df89036c8e5f9ba9a",  # פעיל מאוד | קריפטו XRP | +$2.18M
    "coinman2":            "0x55be7aa03ecfbe37aa5460db791205f7ac9ddca3",  # פעיל מאוד | קריפטו ETH/SOL | +$937K
    "0xafEe":              "0xee50a31c3f5a7c77824b12a941a54388a2827ed6",  # חצי פעיל | טכנולוגיה/AI | +$1.19M
}

# ────────────────────────────────────────────────────────────────────────────────
# ארנקי לווייתנים בעלי היסטוריה חזקה — התראה חמה בלבד (לא polling שוטף)
# אם חוזרים לסחור — זה אירוע משמעותי ביותר!
# ────────────────────────────────────────────────────────────────────────────────
WHALE_ALERT_WALLETS = {
    "Theo4":      "0x56687bf447db6ffa42ffe2204a05edaa20f55839",  # #1 כל הזמנים | +$22M  | Win Rate 88.9% | לא פעיל מנוב 2024
    "Fredi9999":  "0x1f2dd6d473f3e824cd2f8a89d9c69fb96f6ad0cf",  # #2 כל הזמנים | +$16.6M | Win Rate 73.3% | לא פעיל מנוב 2024
    "Len9311238": "0x78b9ac44a6d7d7a076c14e0ad518b301b63c6b76",  # #4 כל הזמנים | +$8.7M  | Win Rate 100% | לא פעיל מנוב 2024
    "zxgngl":     "0xd235973291b2b75ff4070e9c0b01728c520b0f29",  # #5 כל הזמנים | +$7.8M  | Win Rate 80%  | לא פעיל מנוב 2024
    "RepTrump":   "0x863134d00841b2e200492805a01e1e2f5defaa53",  # #6 כל הזמנים | +$7.5M  | Win Rate 100% | לא פעיל מנוב 2024
}

# תאימות לאחורה — שומרים על תאימות שישים מ -WHALE_WALLETS / EXPERT_WALLETS
WHALE_WALLETS  = ACTIVE_WALLETS   # בקשרת אחורה לקוד שמשתמש ב-WHALE_WALLETS
EXPERT_WALLETS = ACTIVE_WALLETS   # בקשרת אחורה לקוד שמשתמש ב-EXPERT_WALLETS
...
# ─── פרש מחיר לפי תחום ──────────────────────────────────────────────────────
# ספורט אירופאי: פרש טבעי גדול יותר — המומחים קונים לפני שהמחיר זז
# win rate ספורט: 94.6% — מצדיק סף גמיש יותר
DOMAIN_SPREAD_OVERRIDES = {
    "sports":      50,   # ספורט — פרש עד 50% (שווקי כדורגל/NBA עם נזילות נמוכה)
    "politics":    25,   # פוליטיקה — פרש עד 25%
    "geopolitics": 30,   # גיאופוליטיקה — פרש עד 30%
    "crypto":      25,   # קריפטו — פרש עד 25%
    "economy":     20,   # כלכלה — ברירת מחדל
    "tech":        20,   # טכנולוגיה — ברירת מחדל
    "entertainment": 20, # בידור — ברירת מחדל
    "general":     40,   # כללי — פרש עד 40% (רוב שווקי ספורט מסווגים כ-general)
}
...
# ─── שיפ# ─── Drift Detection — זיהוי שינוי התנהגות מומחים ─────────────────
DRIFT_DETECTION_DAYS     = 30   # ימים אחרונים לבדיקת drift
DRIFT_ALERT_THRESHOLD    = 20   # אחוז שינוי ב-win_rate שמפעיל התראה

# ─── Activity Check — פעילות רציפה של מומחים ────────────────────────
# מומחה שלא סחר יותר מ-N ימים נחסם לחלוטין (לא רלוונטי יותר)
EXPERT_INACTIVITY_BLOCK_DAYS = 90  # >90 ימים ללא עסקה = חסום
